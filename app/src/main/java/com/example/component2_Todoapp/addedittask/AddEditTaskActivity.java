...
public class AddEditTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditText = findViewById( R.id.edit_text_taskDescription);
    ...
    public int getPriorityFromViews() {
        ...
        switch (checkedId) {
            case R.id.rad_button1:
                priority = PRIORITY_HIGH;
                break;
            case R.id.rad_button2:
                priority = PRIORITY_MEDIUM;
                break;
            case R.id.rad_button3:
    ...
    public void setPriorityInViews(int priority) {
        switch (priority) {
            case PRIORITY_HIGH:
                ((RadioGroup) findViewById(R.id.radio_group)).check(R.id.rad_button1);
                break;
            case PRIORITY_MEDIUM:
                ((RadioGroup) findViewById(R.id.radio_group)).check(R.id.rad_button2);
                break;
            case PRIORITY_LOW:
                ((RadioGroup) findViewById(R.id.radio_group)).check(R.id.rad_button3);
        }
    }
    @Override
